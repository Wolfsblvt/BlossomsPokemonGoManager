...
public class MenuBar extends JMenuBar {
	...
	public MenuBar(PokemonGo go) {
		...
		about.addActionListener(l -> JOptionPane.showMessageDialog(null,
				...
				"About Blossom's Pokemon Go Manager", JOptionPane.PLAIN_MESSAGE));
	...
	private void displayTrainerStats() throws Exception {
		...
		Object[] tstats = { "Trainer Name: " + go.getPlayerProfile().getUsername(),
				"Team: " + go.getPlayerProfile().getTeam().toString(),
				"Level: " + go.getPlayerProfile().getStats().getLevel(),
				"XP: " + go.getPlayerProfile().getStats().getExperience() + " ("
						+ go.getPlayerProfile().getStats().getNextLevelXp() + " to next level)",
